...
<html>
	...
	<body>
		<a href="#edit-channel" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-channel" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:channelInstance, action:'update']" method="PUT" >
