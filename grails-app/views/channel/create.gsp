...
<html>
	...
	<body>
		<a href="#create-channel" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-channel" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:channelInstance, action:'save']" >
				<fieldset class="form">
